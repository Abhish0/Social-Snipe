    ...
    <h4 className="rightbarTitle">User friends</h4>
      <div className="rightbarFollowings">
        {friends.map((friend)=>(
            ...
            <img src={friend.profilePicture? PF+friend.profilePicture : PF+"person/noAvatar.jpg"} alt="person" className="rightbarFollowingImg" />
  ...
  return (
    <div className='rightbar'>
     <div className="rightbarWrapper">
      { currentUser && user ? <ProfileRightBar/> : <HomeRightBar/>}
     </div>
    </div>
  )
}
